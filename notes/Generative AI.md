...
> The exciting truth is, we don’t really know what’s coming next. While creative industries will feel the impact first, this tech will give creative superpowers to everybody. In the longer term, it could be used to generate designs for almost anything. The problem is, these models still have no idea what they’re doing.
*—Will Douglas Heaven*
...
> AI art generators never work exactly how you want them to. They often produce hideous results that can resemble distorted stock art, at best. In my experience, the only way to really make the work look good is to add descriptor at the end with a style that looks aesthetically pleasing.*~Erik Carter*
